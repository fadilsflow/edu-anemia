...
import { Highlighter } from './ui/highlighter' // Assuming Highlighter is available
            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="bg-card  p-10 rounded-t-2xl  items-center flex flex-col text-center">
                    ...
                    <p className="text-muted-foreground mx-auto mt-4 mb-8 max-w-xl text-lg">
                        Kenali kondisi tubuhmu dengan menjawab beberapa pertanyaan sederhana. Hasilnya membantu kamu memahami apakah kamu berisiko mengalami anemia dan apa langkah yang bisa diambil selanjutnya.
                    </p>
